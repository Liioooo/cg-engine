...
//
//        std::vector<char> vertexSource = ShaderUtils::loadShaderSourceCode(vertexPath, ShaderEnv::Custom);
//        std::vector<char> fragmentSource = ShaderUtils::loadShaderSourceCode(fragmentPath, ShaderEnv::Custom);
//        std::vector<char> geometrySource = ShaderUtils::loadShaderSourceCode(geometryPath, ShaderEnv::Custom);
//        std::vector<char> tcsSource = ShaderUtils::loadShaderSourceCode(tcsPath, ShaderEnv::Custom);
//        std::vector<char> tesSource = ShaderUtils::loadShaderSourceCode(tesPath, ShaderEnv::Custom);
//
...
//
//        std::vector<char> source = ShaderUtils::loadShaderSourceCode(path, ShaderEnv::Custom);
//
...
//        glShaderBinary(1, &id, GL_SHADER_BINARY_FORMAT_SPIR_V, source.data(), static_cast<int>(source.size()) * sizeof(char));
